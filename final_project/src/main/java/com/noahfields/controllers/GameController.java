...
public class GameController {
	...
	//index generates the home page of the website
	...
	// postIndex handles the post request generated by pressing either the next or previous arrow, re-generating the games displayed on the home page
	...
	//getGameDetail generates a games detail page, with all of its details
	@GetMapping("/games/{id}")
